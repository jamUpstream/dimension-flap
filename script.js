...
const PIPE_WIDTH = 52;
const MIN_GAP = 100;    // base pipe gap — grows by MIN_GAP_STEP every 100 points (adjustable)
const PIPE_SPAWN_DIST = 160;    // spacing between pipes (base value — adjustable)
